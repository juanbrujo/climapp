...
(function($) {
	...
	$.weatherSlider = function(el, options) {
		...
		ws.parseData = function(wData,id,what){
			...
			iData += '<p class="ws-line temperatura">'+ws.l.ht+': '+tempmax+' °'+m.t+' &middot; '+ws.l.lt+': '+tempmin+' °'+m.t+' &middot; '+ws.l.hu+': '+wData.current_condition.humidity+'%</p>';
			iData += '<p class="ws-line">'+ws.l.pr+': '+prec+' '+m.pr+' &middot; '+ws.l.wi+': '+wData.current_condition.wind.direction+' &middot; '+wspeed+' '+m.s+'</p>';
